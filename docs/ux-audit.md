...
- **Files:** All files in `src/react/screens/`, `src/react/components/`, `src/react/modals/`
...
- **File:** `src/progression.ts` (lines 96-113)
...
- **Files:** `src/react/modals/CoinTossModal.tsx`, `TrapPromptModal.tsx`, `GauntletTransitionModal.tsx`
...
- **Files:** `src/engine.ts` (attack method ~line 814), `src/react/screens/DeckbuilderScreen.tsx`
...
- **Files:** `src/ai-orchestrator.ts`, `src/react/screens/game/`
...
- **Files:** `src/campaign.ts`, `src/react/screens/CampaignScreen.tsx`
...
- **Files:** `src/campaign-store.ts` (lines 21-46), `src/react/screens/CampaignScreen.tsx`
...
- **File:** `src/progression.ts` (lines 50-59)
...
- **File:** `src/engine.ts` (lines 215-222), `css/style.css`
...
- **File:** `src/react/screens/DeckbuilderScreen.tsx`
...
- **Files:** `src/react/App.tsx`, `css/style.css`
...
- **Files:** All modals in `src/react/modals/`
...
- **File:** `src/react/screens/game/PhaseControls.tsx`
...
- **Files:** `src/shop-data.ts`, `src/react/screens/ShopScreen.tsx`
...
- **File:** `src/react/screens/CampaignScreen.tsx`
...
- **File:** `src/react/screens/ShopScreen.tsx`
...
- **Files:** `src/field.ts` (lines 22-30), `src/react/components/FieldCardComponent.tsx`
...
- **Files:** `src/react/screens/CampaignScreen.tsx` (nodes are `<div>` with onClick), various components
...
- **Files:** `src/field.ts`, `src/react/components/FieldCardComponent.tsx`
...
- **File:** `src/react/screens/game/HandArea.tsx`
...
- **File:** `src/react/components/ErrorBoundary.tsx`
...
- **File:** `src/react/hooks/useLongPress.ts`
