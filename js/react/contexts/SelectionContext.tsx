...
export type SelMode =
  ...
  | 'grave-target' | 'trap-target' | 'equip-target'
  | 'place-monster' | 'place-spell' | null;
...
const EMPTY: Selection = {
  ...
  equipHandIndex: null, equipCard: null,
  placeHandIndex: null, placePosition: null, placeFaceDown: false,
  callback: null, hint: '',
};
