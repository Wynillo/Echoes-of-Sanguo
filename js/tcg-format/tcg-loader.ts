...
import type { TcgCard, TcgCardDefinition, TcgMeta, TcgOpponentDeck, TcgOpponentDescription, TcgTypesJson, TcgShopJson, TcgCampaignJson, TcgLoadResult } from './types.js';
